...
const Navbar = () => {
    return (
        <div className="relative flex w-full items-center justify-center mt-8 lg:mt-10">
            <div className="flex items-center justify-between px-4 lg:px-12 w-[90%] xl:w-[60%] h-18 rounded-2xl border-4 border-white">
                <div className="absolute left-1/2 -translate-x-[50%] inset-0 bg-semipink filter blur-sm w-[90%] xl:w-[60%] z-0"></div>
